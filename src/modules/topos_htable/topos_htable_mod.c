...
str _tps_htable_dialog = {"topos_dialog", 12};
str _tps_htable_transaction = {"topos_transaction", 17};
...
static int mod_init(void)
{
	...
	if(_tps_htable_api.table_spec("topos_transaction=>size=4;autoexpire=7200;")
			< 0) {
